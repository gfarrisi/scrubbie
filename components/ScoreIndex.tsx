    ...
    <>
      <div
        style={{
            ...
            borderRadius: `${min === 0 && max !== 100 ? '10px 0px 0px 10px' :max === 100 ? '0px 10px 10px 0px' : '0px 0px 0px 0px'}`, 
            position: 'relative',
        }}
      >
        <div
              ...
              <div>
                ...
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" width="37" height="45" viewBox="0 0 37 45" fill="none">
                    <g opacity="0.3">
                    <rect x="0.935303" y="0.455688" width="35.9318" height="35.9318" rx="17.9659" fill={color}
                    />
                    <path d="M18.9012 44.1974L6.00717 30.9777L31.7953 30.9777L18.9012 44.1974Z" fill={color}/>
                    </g>
                  </svg>
                </div>
              </div>
              <div
               style={{
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                  <circle cx="6.90161" cy="6.80627" r="5.73389" fill={color} stroke="white" stroke-width="2"/>
                </svg>
              </div>
            </div>
          )
